...
SRCS = main.c collision.c draw_map.c draw_player.c hooks_handler.c utils.c raycasting.c cleanup.c \
	   ...
	   parsing/parse_file_utils.c raycasting_utils.c hooks_handler_utils.c
OBJS = $(SRCS:.c=.o)
